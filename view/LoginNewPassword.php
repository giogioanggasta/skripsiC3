...
<br>
<a class="w3-display-middle" style="color:black; float: center; text-decoration: none; margin-top: -5%;">Password telah berhasil diubah!</a>
<form>
        <div class="login">
            <fieldset style="width:120%">
                <div class="isi">
                    ...
                    <br><br>
                    <input type="text" name="Password" placeholder="Password" required style="width: 70vh; height: 2.5vw border: 1px solid #ccc; padding: 6px">
                    <br>
                    <br>
                    <button onclick="location.href = 'Home-logged.php'" class="button" style="color:black;">LOGIN</button>
                </div>
            </fieldset>
        </div>
</form>
