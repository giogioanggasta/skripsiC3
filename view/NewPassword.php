...
<form>
        <div class="login">
            <fieldset style="width:120%">
                <div class="isi">
                    <br>
                    <input type="text" name="newpassword" placeholder="Password baru" required style="width: 70vh; height: 2.5vw; border: 1px solid #ccc; padding: 12px;">
                    <br><br>
                    <input type="text" name="retype" placeholder="Ketik kembali Password baru" required style="width: 70vh; height: 2.5vw; border: 1px solid #ccc; padding: 6px">
                    <br>
                    <br>
                    <button onclick="location.href = 'Home.php'" class="button" style="color:black;">Konfirmasi</button>
                </div>
            </fieldset>
        </div>
</form>
