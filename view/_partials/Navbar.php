<div class="w3-bar w3-white w3-border" id="menu">
    ...
    <a href="../controller/UserController.php?q=logout" class="w3-bar-item" style="float: right; margin-top:2%; text-decoration: none;"><img src="../images/logout.png" style="width:25px"></a>
