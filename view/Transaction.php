...
<div class="w3-bar w3-white w3-border" id="menu">
  ...
  <a href="TransactionServices.php" class="w3-bar-item"><img src="../images/transactionservices.png" style="width:150px; float:left;; margin-left: 10%"></a>
  <h2 style="float:left;margin-top:15%; margin-left: -8.5%">Jasa</h2>
  <a href="TransactionProduct.php" class="w3-bar-item"><img src="../images/transactionproduct.png" style="width:150px;margin-left: 20%; float:left"></a>
  <h2 style="float:left;margin-top:15%; margin-left: -8.75%">Produk</h2>
</div>
</html>